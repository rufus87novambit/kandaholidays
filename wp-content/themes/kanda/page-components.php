...
<?php get_header(); ?>
    ...
    <div class="row">
        ...
        <div class="primary col-sm-9">
            <div class="box">
                <h2 class="page-title">CHOOSE YOUR DESTINATION</h2>
                <form class="form-block form-inline">
                        ...
                        <ul class="block-sm-3">
                            <li>
                                <label class="ctrl-field -rbtn">
                                    ...
                                    <span class="ctrl-label">radio</span>
                                </label>
                            </li>
                            <li>
                                <label class="ctrl-field -rbtn">
                            ...
                            <li>
                                <label class="ctrl-field -chbox">
                                    <input type='checkbox' class="ctrl-inp" name="radio_group3" checked>
                                    <span class="ctrl-btn"></span>
                    ...
                    <fieldset class="fieldset sep-btm">
                        <div class="col-sm-8">
                            <div class="form-group row clearfix">
                                <label class="form-label col-sm-5">Search By Hotel Name</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row clearfix">
                                <label class="form-label col-sm-5">Search By Star Rating</label>
                            ...
                            <div class="form-group row clearfix">
                                <label class="form-label col-sm-5">Include Hotels In Request</label>
                                <div class="select-wrap col-sm-7">
                                    <select class="custom-select" name="name[]">
                                        <option class="placeholder" selected disabled>1</option>
                                        <option>value1</option>
                            ...
                            <div class="form-group row clearfix">
                                <label class="form-label col-sm-5">Nationality</label>
                                <div class="select-wrap col-sm-7">
                                    <select class="custom-select" name="name[]">
                                        <option class="placeholder" selected disabled>1</option>
                                        <option>value1</option>
                            ...
                            <div class="form-group row clearfix">
                                <label class="form-label col-sm-5">Select Rate Value</label>
                                <div class="select-wrap col-sm-7">
                                    <select class="custom-select" name="name[]">
                                        <option class="placeholder" selected disabled>1</option>
                                        <option>value1</option>
                    ...
                    <div class="text-right clearfix">
                        <input class="btn -primary" type="submit" value="Search Hotel">
                    </div>
                </form>
            </div>
        </div>
