            ...
            <div class="tbody">
                ...
                if (isset($room['rate']) && $room['rate']) { ?>
                    <div class="tr">
                        ...
                        <div class="td"><?php echo kanda_generate_price($room['rate'], $args['hotelcode'], $args['currency'], $room['currcode'], $args['request']['nights_count']) + kanda_get_user_additional_fee(); ?></div>
                    </div>
                <?php }
