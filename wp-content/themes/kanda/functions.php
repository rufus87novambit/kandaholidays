...
if ( ! defined( 'KANDA_CUSTOMIZER_PATH' ) ) {
    define( 'KANDA_CUSTOMIZER_PATH', trailingslashit( KANDA_ADMIN_PATH . 'customizer' ) );
}
if ( ! defined( 'KANDA_CUSTOMIZER_URL' ) ) {
    define( 'KANDA_CUSTOMIZER_URL', KANDA_ADMIN_PATH . 'customizer/' );
}
