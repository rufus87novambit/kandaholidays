<div id="search-criteria">
    <form class="form-block form-inline" method="post">
        ...
        <div class="fieldset clearfix sep-btm">
            <div class="row">
                <div class="col-sm-6">
                    <fieldset>
                        <legend><?php esc_html_e( 'SEARCH CRITERIA', 'kanda' ); ?></legend>
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Hotel Name', 'kanda' ); ?></label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Rating', 'kanda' ); ?></label>
                        ...
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Hotels In Request', 'kanda' ); ?></label>
                            <div class="select-wrap col-sm-7">
                                <select class="custom-select" name="name[]">
                        ...
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Nationality', 'kanda' ); ?></label>
                            <div class="select-wrap col-sm-7">
                ...
                <div class="col-sm-6">
                    <fieldset class="fieldset">
                        ...
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Check In date', 'kanda' ); ?></label>
                            <div class="calendar-item col-sm-7">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Check Out date', 'kanda' ); ?></label>
                            <div class="calendar-item col-sm-7">
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row clearfix">
                            <label class="form-label col-sm-5"><?php esc_html_e( 'Number Of Nights', 'kanda' ); ?></label>
                            <div class="select-wrap col-sm-7">
