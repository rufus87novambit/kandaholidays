<?php
$start_date = DateTime::createFromFormat( 'd F, Y', $this->response->request['start_date'] )->format( 'Ymd' );
$end_date = DateTime::createFromFormat( 'd F, Y', $this->response->request['end_date'] )->format( 'Ymd' );
?>
