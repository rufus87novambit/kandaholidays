...
if ( ! defined( 'KH_THEME_URL' ) ) {
    define( 'KH_THEME_URL', get_template_directory_uri() . '/' );
}

if ( ! defined( 'KH_INCLUDES_PATH' ) ) {
    define( 'KH_INCLUDES_PATH', trailingslashit( KH_THEME_PATH . 'includes' ) );
}
...
if ( ! defined( 'KH_SERVICES_PATH' ) ) {
    define( 'KH_SERVICES_PATH', trailingslashit( KH_INCLUDES_PATH . 'services' ) );
}
...
if ( ! defined( 'KH_ADMIN_PATH' ) ) {
    define( 'KH_ADMIN_PATH', trailingslashit( KH_INCLUDES_PATH . 'admin' ) );
}
...
if ( ! defined( 'KH_FRONT_PATH' ) ) {
    define( 'KH_FRONT_PATH', trailingslashit( KH_INCLUDES_PATH . 'front' ) );
}
